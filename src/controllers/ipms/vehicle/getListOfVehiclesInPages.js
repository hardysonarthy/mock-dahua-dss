...
module.exports = async (req, res, next) => {
	const {
		...
		entanceEffectiveStartTime,
		entanceEffectiveEndTime,
		entanceFailureStartTime,
		entanceFailureEndTime,
		surveyEffectiveStartTime,
		surveyEffectiveEndTime,
		surveyFailureStartTime,
		surveyFailureEndTime,
		containVisitorVehicle,
	} = req.query;
	const token =
